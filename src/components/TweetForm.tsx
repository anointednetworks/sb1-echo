...
export default function TweetForm({ onTweetCreated }: { onTweetCreated: () => void }) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="bg-white dark:bg-gray-800 rounded-lg shadow p-4 mb-4 glow-white">
      <textarea
      ...
      <div className="flex justify-between items-center mt-2">
        ...
        <div className="flex items-center space-x-3">
          ...
          <button
            ...
            className="px-4 py-2 bg-blue-500 text-white rounded-full hover:bg-blue-600 disabled:opacity-50 button-glow"
          >
